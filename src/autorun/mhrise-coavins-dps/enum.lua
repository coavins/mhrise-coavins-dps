...
this.ENUM_KEYBOARD_KEY[3] = 'Cancel'
...
this.ENUM_KEYBOARD_KEY[19] = 'Pause'
this.ENUM_KEYBOARD_KEY[20] = 'Capital'
this.ENUM_KEYBOARD_KEY[21] = 'Kana'
this.ENUM_KEYBOARD_KEY[23] = 'Junja'
this.ENUM_KEYBOARD_KEY[24] = 'Final'
this.ENUM_KEYBOARD_KEY[25] = 'Hanja'
...
this.ENUM_KEYBOARD_KEY[42] = 'Print'
...
this.ENUM_KEYBOARD_KEY[48] = 'Alpha0'
this.ENUM_KEYBOARD_KEY[49] = 'Alpha1'
this.ENUM_KEYBOARD_KEY[50] = 'Alpha2'
this.ENUM_KEYBOARD_KEY[51] = 'Alpha3'
this.ENUM_KEYBOARD_KEY[52] = 'Alpha4'
this.ENUM_KEYBOARD_KEY[53] = 'Alpha5'
this.ENUM_KEYBOARD_KEY[54] = 'Alpha6'
this.ENUM_KEYBOARD_KEY[55] = 'Alpha7'
this.ENUM_KEYBOARD_KEY[56] = 'Alpha8'
this.ENUM_KEYBOARD_KEY[57] = 'Alpha9'
...
this.ENUM_KEYBOARD_KEY[96] = 'NumPad0'
this.ENUM_KEYBOARD_KEY[97] = 'NumPad1'
this.ENUM_KEYBOARD_KEY[98] = 'NumPad2'
this.ENUM_KEYBOARD_KEY[99] = 'NumPad3'
this.ENUM_KEYBOARD_KEY[100] = 'NumPad4'
this.ENUM_KEYBOARD_KEY[101] = 'NumPad5'
this.ENUM_KEYBOARD_KEY[102] = 'NumPad6'
this.ENUM_KEYBOARD_KEY[103] = 'NumPad7'
this.ENUM_KEYBOARD_KEY[104] = 'NumPad8'
this.ENUM_KEYBOARD_KEY[105] = 'NumPad9'
this.ENUM_KEYBOARD_KEY[106] = 'Multiply'
this.ENUM_KEYBOARD_KEY[107] = 'Add'
this.ENUM_KEYBOARD_KEY[108] = 'Separator'
this.ENUM_KEYBOARD_KEY[109] = 'Subtract'
this.ENUM_KEYBOARD_KEY[110] = 'Decimal'
this.ENUM_KEYBOARD_KEY[111] = 'Divide'
...
this.ENUM_KEYBOARD_KEY[145] = 'Scroll'
this.ENUM_KEYBOARD_KEY[146] = 'NumPadEnter'
this.ENUM_KEYBOARD_KEY[160] = 'LShift'
this.ENUM_KEYBOARD_KEY[161] = 'RShift'
this.ENUM_KEYBOARD_KEY[162] = 'LControl'
this.ENUM_KEYBOARD_KEY[163] = 'RControl'
this.ENUM_KEYBOARD_KEY[164] = 'LMenu'
this.ENUM_KEYBOARD_KEY[165] = 'RMenu'
this.ENUM_KEYBOARD_KEY[186] = 'OEM_1'
this.ENUM_KEYBOARD_KEY[187] = 'OEM_Plus'
this.ENUM_KEYBOARD_KEY[188] = 'OEM_Comma'
this.ENUM_KEYBOARD_KEY[189] = 'OEM_Minus'
this.ENUM_KEYBOARD_KEY[190] = 'OEM_Period'
this.ENUM_KEYBOARD_KEY[191] = 'Slash'
this.ENUM_KEYBOARD_KEY[192] = 'OEM_3'
this.ENUM_KEYBOARD_KEY[219] = 'OEM_4'
this.ENUM_KEYBOARD_KEY[220] = 'OEM_5'
this.ENUM_KEYBOARD_KEY[221] = 'OEM_6'
this.ENUM_KEYBOARD_KEY[222] = 'OEM_7'
this.ENUM_KEYBOARD_KEY[223] = 'OEM_8'
this.ENUM_KEYBOARD_KEY[226] = 'OEM_102'
this.ENUM_KEYBOARD_KEY[220] = 'BackSlash'
this.ENUM_KEYBOARD_KEY[254] = 'DefinedEnter'
this.ENUM_KEYBOARD_KEY[255] = 'DefinedCancel'
...
this.ATTACKER_TYPES = {}
this.ATTACKER_TYPES[0] = 'weapon'
this.ATTACKER_TYPES[1] = 'barrelbombl'
...
this.ATTACKER_TYPES[8] = 'barrelbombs'
this.ATTACKER_TYPES[9] = 'kunai'
this.ATTACKER_TYPES[10] = 'waterbeetle'
this.ATTACKER_TYPES[11] = 'detonationgrenade'
this.ATTACKER_TYPES[12] = 'hmballista'
this.ATTACKER_TYPES[13] = 'hmcannon'
this.ATTACKER_TYPES[14] = 'hmgatling'
this.ATTACKER_TYPES[15] = 'hmtrap'
this.ATTACKER_TYPES[16] = 'hmnpc'
this.ATTACKER_TYPES[17] = 'hmflamethrower'
this.ATTACKER_TYPES[18] = 'hmdragonator'
this.ATTACKER_TYPES[19] = 'otomo'
this.ATTACKER_TYPES[20] = 'fg005'
this.ATTACKER_TYPES[21] = 'ecbatexplode'
this.ATTACKER_TYPES[23] = 'monster'
-- defined here for convenience, but is not really in the game
this.ATTACKER_TYPES[125] = 'marionette'

this.ATTACKER_TYPE_TEXT = {}
this.ATTACKER_TYPE_TEXT['weapon']            = 'Weapon'
this.ATTACKER_TYPE_TEXT['barrelbombl']       = 'Large Barrel Bomb'
...
this.ATTACKER_TYPE_TEXT['barrelbombs']       = 'Barrel Bomb'
